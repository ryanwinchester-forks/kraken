...
class Profile extends BaseModel {
     ...
     * @var string
     */
    protected $presenter = 'Kraken\Presenters\ProfilePresenter';
    ...
    {
        return $this->belongsToMany('Kraken\Models\Field')->withPivot('value')->withTimeStamps();
    }
    ...
    {
        return $this->belongsToMany('Kraken\Models\Form')->withTimeStamps();
    }
