...
var _Edit = require('./Forms/Edit.js');
...
React.render(React.createElement(_Edit2['default'], { source: source }), document.getElementById('form'));

},{"./Forms/Edit.js":175}],2:[function(require,module,exports){
...
var Edit = _React2["default"].createClass({
    ...
    render: function render() {
        var propertyListItems = this.state.properties.map(function (property, i) {
